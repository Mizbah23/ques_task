    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-info white">
                <h5 class="modal-title" id="myModalLabel130" style="text-align: center;">Add New Supplier</h5>
                         ...
                         <div class="row">
                             ...
                             <div class="col-md-12 col-xl-12">
                                 <div class="form-group">
                                     <label for="first-name-icon">Supplier Name</label>
    ...
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header bg-success white">
                <h5 class="modal-title" id="myModalLabel130" style="text-align: center;">Update Supplier</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
...
<!--                                    <li class="breadcrumb-item"><a href="#">Components</a>
                         ...
                         <li class="breadcrumb-item active"> <span class="badge badge-primary">Supplier Management</span>
                        </li>
                        
                    </ol>

                    <button type="button" class="addnew btn-sm btn-primary waves-effect waves-light" data-toggle="modal">
                    <i class="feather icon-plus-circle"></i> New Supplier
                    </button>
                </div>
...
{
    $.ajax({
      type: 'POST',url: "{{route('sts.supplier')}}",
      data: {
...
{
    $.ajax({type: 'POST',url: "{{route('del.supplier')}}",
