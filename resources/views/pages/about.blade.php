        ...
        <form method="post"  id="addFrm" enctype="multipart/form-data"> 
                <div class="row">
                    <div class="col-md-6 col-xl-6">
                        ...
                        <div class="form-group checkmail">
                            <label for="first-name-icon">Subtitle</label> 
                             <input type="text" class="form-control" name="subtitle" placeholder="Enter Subtitle" autocomplete="off">
                            <div class="valid-feedback"></div><div class="invalid-feedback eitxt"></div>
                        </div>
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="form-group">
                            <label for="exampleInputFile">Image in About Section*</label>
                            <div class="controls">
            ...
            <input type="hidden" name="oldimg" id="oldimg">
                <div class="row">
                    <div class="col-md-6 col-xl-6">
                        ...
                        <div class="form-group checkmail">
                            <label for="first-name-icon">Subtitle</label> 
                             <input type="text" class="form-control" name="usubtitle" id="usubtitle"  placeholder="Enter event location">
                            <div class="valid-feedback"></div><div class="invalid-feedback eitxt"></div>
                        </div>
...
<!--                                    <li class="breadcrumb-item"><a href="#">Components</a>
                         ...
                         <li class="breadcrumb-item active"> <span class="badge badge-primary">About Us</span>
                        </li>
                        
                    </ol>

                    {{-- <button type="button" class="openAdd btn-sm btn-primary waves-effect waves-light" data-toggle="modal">
                    <i class="feather icon-plus-circle"></i> About Us
                    </button> --}}
                </div>
...
CKEDITOR.replace('udetails');
    ...
    var table = $('#userTbl').DataTable(
    {
        ...
        "ajax":{"url":"{{route('list.about')}}","dataType":"json",
...
{  
    ...
    $.ajax({type: 'POST',
        url: "{{route('update.about')}}",data:formData,
