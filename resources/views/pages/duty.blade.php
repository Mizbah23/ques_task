                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xl-6">
                        <div class="form-group">
                            <label for="exampleInputFile">Image in Duty Section*</label>
                            <div class="controls">
...
<!--                                    <li class="breadcrumb-item"><a href="#">Components</a>
                         ...
                         <li class="breadcrumb-item active"> <span class="badge badge-primary">Duty</span>
                        </li>
                        
                    </ol>

                    {{-- <button type="button" class="openAdd btn-sm btn-primary waves-effect waves-light" data-toggle="modal">
                    <i class="feather icon-plus-circle"></i> Duty Section
                    </button> --}}
                </div>
...
CKEDITOR.replace('udetails');
    ...
    var table = $('#userTbl').DataTable(
    {
        ...
        "ajax":{"url":"{{route('list.duty')}}","dataType":"json",
...
{  
    ...
    $.ajax({type: 'POST',
        url: "{{route('update.duty')}}",data:formData,
